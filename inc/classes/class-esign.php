...
class Esign {
	...
	protected function setup_hooks() {
		$this->prefix = 'esig';
		add_filter( 'futurewordpress/project/quizandfiltersearch/contract/pdfcontent', [ $this, 'pdfContent' ], 10, 2 );
		...
		add_filter( 'futurewordpress/project/quizandfiltersearch/action/contractforms', [ $this, 'contractForms' ], 10, 2 );
		// add_filter( 'futurewordpress/project/quizandfiltersearch/action/contractforms', [ $this, 'contractForms' ], 10, 2 );
		add_filter( 'futurewordpress/project/quizandfiltersearch/esign/userdocument', [ $this, 'getLastDocument' ], 10, 2 );
		add_filter( 'futurewordpress/project/quizandfiltersearch/action/contracts', [ $this, 'contracts' ], 10, 2 ); // C:\workspace\New folder\e-signature\e-signature\models\Document.php: 52
	 ...
	 * $content = apply_filters('futurewordpress/project/quizandfiltersearch/hooks/esignpdfcontent', $unfiltered_content, [ $document_id,$document ] ); //  $unfiltered_content //apply_filters('the_content', $unfiltered_content);
	 * 
	...
	public function esignature_content( $unfiltered_content, $args ) {
		$replace = apply_filters( 'futurewordpress/project/quizandfiltersearch/contract/pdfcontent', [], $args );
	...
	public function contractForms( $default, $special = false ) {
		...
		for( $i = 1;$i <= apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'regis-rows', 3 ); $i++ ) {
			$default[ $i ] = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'regis-link-title-' . $i, 'Link title #' . $i );
		}
		return $default;
	}
