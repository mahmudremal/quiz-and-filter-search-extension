...
class Notices {
	...
	private function notice() {
		$args = [
			// 'confirm'	=> __( 'Are you sure you want to disapear this message?', 'quiz-and-filter-search-domain' ),
			// 'request'	=> []
		];
		?>
		<div class="notice fwp-notice fwp-notice--dismissible fwp-notice--extended">
			...
			<div class="fwp-notice__content">
				<h3><?php esc_html_e('Congratulations! Love using this Plugin?.', 'quiz-and-filter-search-domain'); ?></h3>
				<p><?php esc_html_e('Become a super contributor by opting in to share non-sensitive plugin data and to receive periodic email updates from us.', 'quiz-and-filter-search-domain') ?> <a href="#!" target="_blank"><?php esc_html_e('Learn more.', 'quiz-and-filter-search-domain') ?></a>
			</p>
			<div class="fwp-notice__actions">
				<a href="#!" class="fwp-button">
					<span><?php esc_html_e('Sure! I\'d love to help', 'quiz-and-filter-search-domain') ?></span>
				</a>
				<a href="#!" class="fwp-button fwp-button__outline fwp-notice__cancel">
					<span><?php esc_html_e('No thanks', 'quiz-and-filter-search-domain') ?></span>
				</a>
			</div>
			</div>
		</div>
