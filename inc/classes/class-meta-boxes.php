...
class Meta_Boxes {
	...
	public function add_custom_meta_box() {
		...
		foreach ( $screens as $screen ) {
			add_meta_box(
				...
				__( 'Checkout Video Clip', 'quiz-and-filter-search-domain' ),  // Box title
	...
	public function custom_meta_box_html( $post ) {
		...
		if( ! isset( $meta[ 'full_url' ] ) || empty( $meta[ 'full_url' ] ) ) :
			esc_html_e( 'No video uploaded for this order.', 'quiz-and-filter-search-domain' );
			else :
		?>
		<div class="fwp-tabs__container">
			<div class="fwp-tabs__wrap">
				<div class="fwp-tabs__navs">
					<div class="fwp-tabs__nav-item active" data-target="#the-qrcode"><?php esc_html_e( 'Scan Code', 'quiz-and-filter-search-domain' ); ?></div>
					<div class="fwp-tabs__nav-item" data-target="#the-video"><?php esc_html_e( 'Play Video', 'quiz-and-filter-search-domain' ); ?></div>
				</div>
					...
					<div class="fwp-tabs__content" id="the-video">
						<div class="fwp-video-player-wraper">
							<div class="fwp-video-wrap">
								...
								<!-- <a class="fwp-metabox-download-button" href="<?php echo esc_url( $meta['full_url'] ); ?>" download="<?php echo esc_url( $meta['name'] ); ?>"><?php esc_html_e( 'Download this Video', 'quiz-and-filter-search-domain' ); ?></a> -->
							</div>
						</div>
					</div>
				</div>
