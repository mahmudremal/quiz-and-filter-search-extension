...
class Ftp {
    ...
    add_filter( 'futurewordpress/project/quizandfiltersearch/filesystem/mediadirectory', [ $this, 'getAllLocalFiles' ], 10, 2 );
		// add_action( 'init', [ $this, 'deleteFiles' ], 10, 0 );
	}
	public function initialize() {
    $this->lastError        = false;
    $this->ftpConnect       = false;
    $this->ftpServer        = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'ftp-server', false );
    $this->ftpUsername      = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'ftp-username', false );
    $this->ftpPassword      = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'ftp-password', false );
    $this->ftpDirectory     = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'ftp-remotedir', false );
    $this->localDirectory   = apply_filters( 'futurewordpress/project/quizandfiltersearch/system/getoption', 'ftp-localdir', false );
    if( $this->localDirectory === false || empty( $this->localDirectory ) ) {
      $this->localDirectory = apply_filters( 'futurewordpress/project/quizandfiltersearch/filesystem/uploaddir', false );
    }
	}
  public function syncFiles() {
    // if( ! apply_filters( 'futurewordpress/project/quizandfiltersearch/system/isactive', 'ftp-enable' ) ) {return;}
